...
Proof.
  Hint Constructors ev ev'.
  Hint Resolve ev_sum.
  Hint Extern 1 =>
    match goal with
    | [ H: ev' ?x |- ev' (S (S ?x)) ] => apply (ev'_sum _ _ ev'_2 H)
    end.
  Hint Extern 10 =>
    match goal with
      | [ H: ev ?x |- _ ] => induction H
      | [ H: ev' ?x |- _ ] => induction H
    end.
  crush.
Qed.
...
Proof.
  Hint Constructors ev.
  intros n m H H0;induction H0;crush.
Qed.
(** [] *)
